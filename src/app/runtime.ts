...
async function createRuntimeServices(params: {
  ...
  const pdfPipelineService = new PdfPipelineService({
    ...
    rasterizeDpiStandard: config.pdfRasterizeDpiStandard,
    rasterizeDpiQualitySafe: config.pdfRasterizeDpiQualitySafe,
    ...
    finalPreflightMeasureDpi: config.pdfFinalPreflightMeasureDpi,
    finalPreflightRetryStrictPixels: config.pdfFinalPreflightRetryStrictPixels,
    finalPreflightRetryAggressivePixels: config.pdfFinalPreflightRetryAggressivePixels,
