...
12. Для PDF з QR або Spotify кодом:
   - QR коди рендеруються на 600 DPI-еквіваленті цільового фізичного розміру (A5 ~472px, A4 ~709px) замість дефолтного ~100px;
   - Spotify коди також масштабуються на тій же DPI-еквіваленті, усуваючи downsampling з API 640px;
   - коди повинні виглядати чіткими без видимих upscaling артефактів.
